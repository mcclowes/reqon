...
export default function prismIncludeLanguages(PrismObject: typeof globalThis.Prism): void {
  ...
  PrismObject.languages.vague = {
    ...
    method: /\b(?:get|post|put|patch|delete|call)\b/,
    keyword: /\b(?:mission|source|store|schema|action|run|then|for|in|where|map|validate|match|assume|if|else|let|abort|skip|continue|retry|jump|queue|wait|schedule|every|cron|at|and|or|not|is|from)\b/,
